...
<head>
    ...
    <title>Restablecer contraseña — Stockly</title>
...
<body class="auth-body">
    ...
    <div class="auth-page">
        <div class="auth-card">
            ...
            <h1 class="auth-card__title auth-reveal auth-reveal-2">Elige una contraseña nueva</h1>
            <p class="auth-card__subtitle auth-reveal auth-reveal-3">
                Ya casi terminas -escribe tu nueva contraseña para volver a entrar.
            </p>
