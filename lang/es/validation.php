...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute ingresado ha aparecido en una filtración de datos. Elige un :attribute diferente.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Para que los mensajes de arriba digan "el campo correo electrónico..."
    | en vez de "el campo email...", usando los mismos nombres de los
    | formularios de registro/login/recuperación de clave de Stockly.
    |
    */
    ...
    'attributes' => [
        ...
        'business_type_other' => 'tipo de negocio',
